...
extension LocationManager
{
    ...
    enum Error: LocalizedError, RecoverableError
    {
        ...
        var failureReason: String? {
            switch self
            {
            case .requiresAlwaysAuthorization: return "Whitelist requires location access set to “Always”."
            }
        }
        ...
        var recoverySuggestion: String? {
            switch self
            {
            case .requiresAlwaysAuthorization: return "Please set location access to “Always” so Whitelist can apply changes in the background."
            }
        }
        ...
        var recoveryOptions: [String] {
            switch self
            {
            case .requiresAlwaysAuthorization: return ["Open Settings"]
            }
        }
